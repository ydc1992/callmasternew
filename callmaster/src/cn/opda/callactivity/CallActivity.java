    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				String firstcode = String.copyValueOf(code.toCharArray(),0,1);
				String secondcode = String.copyValueOf(code.toCharArray(),1,1);
				if(firstcode.equals("0")&&code.length()>=10&&code.length()<=11){
				...
				}else if(firstcode.equals("1")&&code.length()==11){
					try {
